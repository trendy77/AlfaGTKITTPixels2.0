...
<body>
 ...
 <a href="#!" class="collection-item align-center blue-grey darken-4" type="button" onclick="sendData(2)">Yellow</button></a>
	 <a href="#!" class="collection-item align-center blue-grey darken-4" type="button" onclick="sendData(5)">Blue</button></a>
 <a href="#!" class="collection-item align-center blue-grey darken-4" type="button" onclick="sendData(8)">Green</button></a>
  		</div>
    </div>
	    <div class="parallax"><img src="https://trendypublishing.com.au/css/arold.jpg" alt="Unsplashed background img 1"></div>
  </div>
       ...
       <p class="dark"><p class="white-text">	Temp Celcius : <span id="alfaTemp">0</span> C</p>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <ul>		
<li><button class="left-align blue-grey darken-4-text" type="button" onclick="sendDelayD(10)">Set DELAY to 10</button></li>
<li><button class="left-align blue-grey darken-4-text" type="button" onclick="sendDataD(30)">Set DELAY to 30</button></li>
<li><button class="left-align blue-grey darken-4-text" type="button" onclick="sendDataD(60)">Set DELAY to 60</button></li>
		   </ul>		
					</div>
        </div>
      </div>
 ...
 Made with a little help & kudos to <a class="brown-text text-lighten-3" href="http://materializecss.com">Materialize</a> as well as <a class="blue-text text-lighten-3" href="http://alfaromeo.com">Alfa Romeo</a>.
